...
class LlamaForSequenceReward(LlamaPreTrainedModel):
    """Llama backbone adapted for scalar sequence reward scoring."""
...
class RewardModelEvaluator:
    ...
    def __init__(self,
        ...
        if torch.cuda.is_available():
            ...
            self.model = LlamaForSequenceReward.from_pretrained(
                model_path,
                config=config,
    ...
    def get_reward_scores_batch(
        ...
        for i in range(0, len(conversations), batch_size):
            ...
            scores = outputs["scores"].squeeze().detach()
