...
class EurusRewardModel(PreTrainedModel):
    """Mistral backbone with a linear value head for scalar reward scoring."""
...
class RewardModelEvaluator:
    ...
    def __init__(self,
        ...
        if torch.cuda.is_available():
            ...
            self.model = EurusRewardModel.from_pretrained(
                model_path,
                config=config,
    ...
    def get_reward_scores_batch(
        ...
        for i in range(0, len(conversations), batch_size):
            ...
            batch_scores = outputs.detach().squeeze(1).cpu().tolist()
