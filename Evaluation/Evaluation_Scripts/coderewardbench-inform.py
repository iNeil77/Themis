...
class INFORMForSequenceClassification(LlamaPreTrainedModel):
    """Llama backbone with a two-layer MLP reward head (INFORM architecture)."""
...
class RewardModelEvaluator:
    """CRB evaluator for INFORM-style MLP-head reward models."""
    ...
    def get_reward_scores_batch(
        ...
        for i in range(0, len(conversations), batch_size):
            ...
            scores = outputs.logits[0][0].squeeze().detach()
