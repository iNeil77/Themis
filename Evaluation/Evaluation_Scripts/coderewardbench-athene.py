...
class AtheneForSequenceClassification(LlamaPreTrainedModel):
    """Llama backbone with a linear value head extracting the score at the CLS token position."""
...
class RewardModelEvaluator:
    """CRB evaluator for Athene-style CLS-token reward models."""
    ...
    def format_conversation(
        ...
        if hasattr(self.tokenizer, 'apply_chat_template') and self.tokenizer.chat_template is not None:
            try:
                ...
                formatted_text = formatted_text + self.tokenizer.cls_token
    ...
    def get_reward_scores_batch(
        ...
        for i in range(0, len(conversations), batch_size):
            ...
            scores = outputs["scores"].detach().cpu().float()
