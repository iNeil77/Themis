...
| **Themis-RM-4B (this model)** | <a href="https://huggingface.co/Qwen/Qwen3-4B" style="white-space: nowrap"><span><img src="https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo.svg" width="16" style="vertical-align: middle"> Qwen/Qwen3-4B</span></a> | — |
...
| | | | | |
| **0.6B - 4B Class** | | | | |
| **Themis-RM-4B (this model)** | **88.39** | 92.46 | 63.81 | 68.02 |
...
model_name = "project-themis/Themis-RM-4B"
device = "cuda:0"
...
This model is released under the [Apache 2.0 License](https://www.apache.org/licenses/LICENSE-2.0). The base model, [Qwen3-4B](https://huggingface.co/Qwen/Qwen3-4B), is also licensed under Apache 2.0.
