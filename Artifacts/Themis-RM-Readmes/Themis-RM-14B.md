...
| **Themis-RM-14B (this model)** | <a href="https://huggingface.co/Qwen/Qwen3-14B" style="white-space: nowrap"><span><img src="https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo.svg" width="16" style="vertical-align: middle"> Qwen/Qwen3-14B</span></a> | — |
...
| | | | | |
| **7B - 14B Class** | | | | |
| **Themis-RM-14B (this model)** | **91.19** | 94.11 | 71.44 | **70.85** |
...
model_name = "project-themis/Themis-RM-14B"
device = "cuda:0"
...
This model is released under the [Apache 2.0 License](https://www.apache.org/licenses/LICENSE-2.0). The base model, [Qwen3-14B](https://huggingface.co/Qwen/Qwen3-14B), is also licensed under Apache 2.0.
